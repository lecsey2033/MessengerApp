...
public class ChatActivity extends AppCompatActivity {
    ...
    private ImageView imageViewSendMassage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        observeViewModel();
        imageViewSendMassage.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void initViews() {
        ...
        imageViewSendMassage = findViewById(R.id.imageViewSendMassage);
    }
